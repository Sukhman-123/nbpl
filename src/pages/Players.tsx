...
const Players = () => {
  ...
  const playersData: Record<string, { name: string; role: string; team: string; runs?: number; wickets?: number; isTopPerformer?: boolean; badge?: string }[]> = {
    "1": [
      { name: "Rahul Sharma", role: "Batsman", team: "Sunny Strikers", runs: 342, isTopPerformer: true, badge: "Orange Cap" },
      { name: "Amit Singh", role: "Bowler", team: "Royal Challengers", wickets: 18, isTopPerformer: true, badge: "Purple Cap" },
      { name: "Vikash Kumar", role: "All-Rounder", team: "Sunny Strikers", runs: 198, wickets: 8 },
      { name: "Deepak Roy", role: "Batsman", team: "NMCC Titans", runs: 256 },
      { name: "Sunil Prasad", role: "Bowler", team: "Royal Challengers", wickets: 14 },
      { name: "Manish Gupta", role: "Wicketkeeper", team: "Thunder Kings", runs: 189 },
      { name: "Rajesh Yadav", role: "All-Rounder", team: "Rising Stars", runs: 145, wickets: 10 },
      { name: "Pradeep Kumar", role: "Batsman", team: "NMCC Titans", runs: 201 },
    ],
    "2": [
      { name: "Vikash Kumar", role: "All-Rounder", team: "NMCC Titans", runs: 389, isTopPerformer: true, badge: "Orange Cap" },
      { name: "Deepak Roy", role: "Bowler", team: "NMCC Titans", wickets: 22, isTopPerformer: true, badge: "Purple Cap" },
      { name: "Rahul Sharma", role: "Batsman", team: "Sunny Strikers", runs: 312 },
      { name: "Arjun Patel", role: "Batsman", team: "Royal Challengers", runs: 278 },
      { name: "Sanjay Verma", role: "Bowler", team: "Thunder Kings", wickets: 16 },
      { name: "Mohit Agarwal", role: "All-Rounder", team: "Rising Stars", runs: 167, wickets: 12 },
      { name: "Nikhil Das", role: "Wicketkeeper", team: "Sunny Strikers", runs: 203 },
      { name: "Aakash Jha", role: "Batsman", team: "NMCC Titans", runs: 245 },
    ],
    "3": [],
  };
